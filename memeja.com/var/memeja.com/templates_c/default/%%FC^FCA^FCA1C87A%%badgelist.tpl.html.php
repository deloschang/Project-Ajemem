...
<!-- Template: achievements/badgelist.tpl.html Start 12/09/2011 22:58:31 --> 
...
<legend><b>Account Holder's Badge:</b></legend>
    <table>
	<tr>
	    <td>
...
?>
		    ...
		    <img src="http://memeja.com/<?php echo $this->_tpl_vars['img_path']['badge_thumb'];  echo $this->_tpl_vars['x']['id_badge']; ?>
...
" />
	...
	<?php if ($this->_tpl_vars['sm']['res']): ?>
		 <tr><td align="right"><a href="http://memeja.com/achievements/badge_list/">View all</a></td></tr>
	    <?php endif; ?>
    </table>
</fieldset>
