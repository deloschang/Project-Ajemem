...
<!-- Template: meme/meme_editor.tpl.html Start 10/09/2011 12:55:55 --> 
...
function show_image(){
	...
	if(im){
		var y=1;
		if(y){
			var url="http://memeja.com/meme/upload_image/ce/0";
			$.ajaxFileUpload({
				url : url,
				secureuri:false,
				...
				complete: function (data, status){
					...
					image_upload_draggable("http://memeja.com/"+z);
					return false;
				 }
			 });
		 }
...
function upload_from_url(){
	...
	var url="http://memeja.com/meme/upload_image";
