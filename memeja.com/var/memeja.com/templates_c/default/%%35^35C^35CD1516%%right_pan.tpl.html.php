...
<?php $this->_cache_serials['/home/bobeveal/public_html/memeja.com/flexycms/../var/memeja.com/templates_c/default/%%35^35C^35CD1516%%right_pan.tpl.html.inc'] = '9a697e3333c06319bcc37d794aa6b9ce'; ?>
<!-- Template: user/right_pan.tpl.html Start 12/09/2011 22:58:31 --> 
 <br/>
	<div class="fbfrnd">
...
<?php if ($_SESSION['id_user']): ?>
    ...
    <div >
		<br>
		<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:9a697e3333c06319bcc37d794aa6b9ce#0}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'user','mgr' => 'user','choice' => 'friend_list','gmod' => 1), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:9a697e3333c06319bcc37d794aa6b9ce#0}';}?>

    </div>
    <div>
		<br>
		<a href="http://memeja.com/manage/suggestion">Features</a>
    </div>
	<div>
	    <br>
	    <?php if ($this->caching && !$this->_cache_including) { echo '{nocache:9a697e3333c06319bcc37d794aa6b9ce#1}';}echo $this->_plugins['function']['get_mod'][0][0]->get_mod(array('mod' => 'paypal','mgr' => 'paypal','choice' => 'form'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:9a697e3333c06319bcc37d794aa6b9ce#1}';}?>
