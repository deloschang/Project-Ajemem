...
<!-- Template: common/menu.tpl.html Start 12/09/2011 23:22:17 --> 
 <?php $this->assign('category', $this->_tpl_vars['util']->get_values_from_config('CATEGORY')); ?>
<div id="navigation">
    <div class="menu-header">
	<ul class="menu">
	    <!--<li <?php if ($_REQUEST['page'] == 'user' && $_REQUEST['choice'] == 'user_home'): ?>class="current"<?php endif; ?>>
		<a href="http://memeja.com/user/user_home">Home</a>
	    </li>-->
		...
		<a href="http://memeja.com/meme/meme_list/cat/main_feed">Home</a>
	    </li>
	    <li <?php if ($_REQUEST['page'] == 'meme' && $_REQUEST['choice'] == 'addMeme'): ?>class="current"<?php endif; ?>>
		<a href="http://memeja.com/meme/addMeme">Make-A-Meme</a>
	    </li>
...
?>
		<li <?php if ($_REQUEST['page'] == 'meme' && $_REQUEST['choice'] == 'meme_list' && $_REQUEST['cat'] == $this->_tpl_vars['key']): ?>class="current"<?php endif; ?>>
		    <a href="http://memeja.com/meme/meme_list/cat/<?php echo $this->_tpl_vars['key']; ?>
"><?php echo $this->_tpl_vars['item']; ?>
		...
		<a href="http://memeja.com/meme/meme_list/cat/top">Top Memes</a>
	    </li>
