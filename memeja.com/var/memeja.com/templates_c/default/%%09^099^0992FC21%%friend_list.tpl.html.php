...
<!-- Template: user/friend_list.tpl.html Start 12/09/2011 22:58:31 --> 
		...
		<table border='1' width='60'>
			<tr>
				<td width="50" height="50">
					<div class='pic_container'><img src="http://memeja.com/<?php echo $this->_tpl_vars['img_path']['avtar_thumb'];  if ($this->_tpl_vars['x']['avatar']):  echo $this->_tpl_vars['x']['avatar'];  else:  if ($this->_tpl_vars['x']['gender'] == 'M'): ?>memeje_male.jpg<?php else: ?>memeje_female.jpg<?php endif;  endif; ?>" height="50px" width="50px"/></div>
...
"><font size='1'><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['x']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 9, "..", true) : smarty_modifier_truncate($_tmp, 9, "..", true)); ?>
	...
	<a href="http://memeja.com/user/all_friends/" style="float:right;">View all</a>
 <?php else: ?>
	You have no friend.
 <?php endif; ?>
</fieldset>
