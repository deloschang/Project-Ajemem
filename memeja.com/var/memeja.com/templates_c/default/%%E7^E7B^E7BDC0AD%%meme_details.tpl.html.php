<?php /* Smarty version 2.6.7, created on 2011-09-09 12:50:21
...
<?php $this->assign('cat', $this->_tpl_vars['util']->get_values_from_config('CATEGORY'));  $this->assign('x', $this->_tpl_vars['sm']['det_meme']); ?>
<div style="width:640px;;height:auto;">
    ...
    <div >
	<img src="http://memeja.com/image/orig/<?php if ($this->_tpl_vars['sm']['fg'] == 1): ?>duel<?php else: ?>meme<?php endif; ?>/<?php echo $this->_tpl_vars['sm']['det_meme']['image']; ?>
" title="Meme" />
    </div>
    <div>
