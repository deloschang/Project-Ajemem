<?php /* Smarty version 2.6.7, created on 2011-09-08 04:41:03
         compiled from caption/add_caption.tpl.html */ ?>

<!-- Template: caption/add_caption.tpl.html Start 08/09/2011 04:41:03 --> 
 <?php echo '
	...
	function caption_post(id){
		...
		if(fg){
		   ...
		   var url = "http://memeja.com/caption/insert_caption";
		   $("#caption"+id).val(\'\');
		   $("#loading"+id).show();
	...
	function get_all_time(){
			   ...
			   var url = "http://memeja.com/caption/get_all_time";
	...
	function set_hnrdishnr(obj,id_cap){
		var url = "http://memeja.com/caption/update_hnr_dishnr";
		var id_meme = "';  echo $this->_tpl_vars['sm']['id'];  echo '";
		var id_cap = id_cap; 
		var flag = $(obj).val();
...
');">
	    <img src="http://memeja.com/spad/site_image/delete.png" title="Close"/>
	</div>
...
" style="position:relative;top:-120px;display:none;">
	<img src="http://memeja.com/templates/images/loadingAnimation.gif" />
    </div>
