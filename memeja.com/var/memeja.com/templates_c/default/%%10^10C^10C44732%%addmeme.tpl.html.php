<?php /* Smarty version 2.6.7, created on 2011-09-10 12:55:55
...
<!-- Template: meme/addmeme.tpl.html Start 10/09/2011 12:55:55 --> 
 <div id="showmodal" class="showmodal">Loading the Memeje Editor.</div>
<script type="text/javascript">
    var last_comic="http://memeja.com/spad/workspace/<?php echo $_SESSION['id_user']; ?>
_img.png";
    var LBL_SITE_URL="http://memeja.com/";
</script>
<script type="text/javascript" src="http://memeja.com/spad/jquery.mousehold.js"></script>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.0/jquery-ui.min.js"></script>
<script type="text/javascript" src="http://memeja.com/spad/scratchpad.js"></script>
<script type="text/javascript" src="http://memeja.com/spad/jquery.jqDock.min.js"></script>
<script type="text/javascript" src="http://memeja.com/spad/color/colorpicker.js"></script>
...
<link type="text/css" href="http://memeja.com/spad/css/colorpicker.css" rel="stylesheet" />
<link rel="stylesheet" href="http://memeja.com/spad/css/spad.css" type="text/css"/>
...
<script type="text/javascript">
	...
	window.location="http://memeja.com/user/user_home";
     }
...
"/>
<form method="post" action="http://memeja.com/meme/meme_insert" enctype="multipart/form-data" name="ques_ans" id="ques_ans">
    <div align="center">
        <?php if ($this->_tpl_vars['sm']['idq']): ?>
...
<?php echo '
	<script typ="text/javascript">
		...
		var url = "http://memeja.com/index.php?page=user&choice=getfriends4tag&flg=1&ce=0";
