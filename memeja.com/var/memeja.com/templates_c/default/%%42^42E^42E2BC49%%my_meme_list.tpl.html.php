...
')"/>
		...
		<?php if ($this->_tpl_vars['sm']['res']): ?>
		    <?php if ($this->_tpl_vars['sm']['flg'] == 1): ?>
			<tr><td align="right"><a href="http://memeja.com/manage/my_favorites/">View all</a></td></tr>
		    <?php elseif ($this->_tpl_vars['sm']['flg'] == 2): ?>
		    ...
		    <?php else: ?>
			<tr><td align="right"><a href="http://memeja.com/manage/my_meme_list/">View all</a></td></tr>
		    <?php endif; ?>
		<?php endif; ?>
	    </table>
</fieldset>