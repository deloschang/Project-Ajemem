...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'meme/loadmorememe.tpl.html', 32, false),array('modifier', 'date_format', 'meme/loadmorememe.tpl.html', 34, false),)), $this); ?>

<!-- Template: meme/loadmorememe.tpl.html Start 12/09/2011 22:58:31 --> 
...
" style="cursor:pointer;width: 100px;height: 100px;" align="left" title="Meme" onclick="show_details('<?php echo $this->_tpl_vars['x']['id_meme']; ?>
');"/>
...
"><?php if ($this->_tpl_vars['sm']['hrc'][$this->_tpl_vars['x']['id_meme']]['caption']):  echo $this->_tpl_vars['sm']['hrc'][$this->_tpl_vars['x']['id_meme']]['caption'];  else:  endif; ?></span></div><br/>	
			<span>
