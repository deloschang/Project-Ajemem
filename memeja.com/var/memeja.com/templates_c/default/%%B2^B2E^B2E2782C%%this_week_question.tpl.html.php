...
<!-- Template: question/this_week_question.tpl.html Start 12/09/2011 22:58:31 --> 
 <?php if ($this->_tpl_vars['sm']['week_quest']): ?>
<table align="center" style="background-color: #B2B2B2">
    <tr style="height:50px;">
	<td height="50px">
<!-- a href="http://memeja.com/question/que_details/id/<?php echo $this->_tpl_vars['sm']['week_quest']['id_question']; ?>
" -->
<a href="http://memeja.com/question/answer_to_ques/idq/<?php echo $this->_tpl_vars['sm']['week_quest']['id_question']; ?>
">
<img src="http://memeja.com/image/thumb/question/<?php echo $this->_tpl_vars['sm']['week_quest']['img_name']; ?>
