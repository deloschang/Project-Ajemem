<?php /* Smarty version 2.6.7, created on 2011-09-10 12:57:30
		...
		<tr>
		    <td>
		     <table>
			    ...
			    <td>
				<div style="height:100px;width:100px"><img src="http://memeja.com/image/thumb/avatar/<?php if ($this->_tpl_vars['sm']['res']['0']['avatar']):  echo $this->_tpl_vars['sm']['res']['0']['avatar'];  else:  if ($this->_tpl_vars['sm']['res']['0']['gender'] == 'M'): ?>memeje_male.jpg<?php else: ?>memeje_female.jpg<?php endif;  endif; ?>" width="<?php echo $this->_tpl_vars['img_path']['thumb_width']; ?>
