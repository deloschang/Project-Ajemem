...
<br/>
 ...
 @ <?php echo ((is_array($_tmp=$this->_tpl_vars['x']['add_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%I:%M %p") : smarty_modifier_date_format($_tmp, "%I:%M %p")); ?>
	    ...
	    <div id="lding_rand" style="display: none;" align="center"><img src="http://memeja.com/templates/images/loadingAnimation.gif" /></div>
	    <div  onclick="show_my_details('<?php echo $this->_tpl_vars['x']['id_meme']; ?>
');" id="comc_img"><br />
		    <img  src="http://memeja.com/image/orig/meme/<?php echo $this->_tpl_vars['x']['image']; ?>
