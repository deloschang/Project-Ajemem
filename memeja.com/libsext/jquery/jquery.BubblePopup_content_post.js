...
(function ($) {
	...
	$.fn.SetBubblePopup = function (options) {
		var _ = {	objTags: ['object', 'embed', 'applet'],
					...
					me: this,
					markup: '\
							<table width="{TABLE_WIDTH}" cellpadding="0" cellspacing="0" style="{IE_FILTER_SHADOW}display:none; z-index:{Z-INDEX}; position:absolute; border:0px; border-collapse:collapse; margin-left:-13px;"> \
							<tbody> \
							<tr> \
		...
		options = $.extend({ 
			...
			color: 'blue',
			imageFolder: 'http://demo1.afixiindia.com/content_post/templates/images/bp_images',
			hideTail: false,
			hideObjectID: [],
			contentStyle: '',
			zIndex: 100,
